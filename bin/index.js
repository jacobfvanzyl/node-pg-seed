...
argv
    .command(
        ...
        'update-seed <target> [domain] [port] [user] [password] [database] [verbose]',
        'Update existing seed files with schema changes.',
        (yargs) => {
            ...
            try {
                ...
                await seed.update_seed(paramObj);
